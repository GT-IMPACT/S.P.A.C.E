...
import space.impact.space.api.world.BiomeBase.Companion.getBiomeAt
import space.impact.space.api.world.world_math.gen.*
...
open class ChunkProviderBase(
    ...
    private var createChunkGenList: ArrayList<CreateChunkGen> = ArrayList()
    private var createChunkGenXZList: ArrayList<CreateChunkGenXZ> = ArrayList()
    private var createChunkGenXYZList: ArrayList<CreateChunkGenXYZ> = ArrayList()
    private var decorateChunkGenList: List<IWorldGenerator> = ArrayList()
    ...
    override var biomesList: ArrayList<BiomeBase> = ArrayList()
    override var standardBiomeOnMap: BiomeBase? = null

    private var currentBiome: BiomeGenBase? = null

    private val decorator: BiomeDecoratorSpaceBase? = null
    ...
    override fun provideChunk(x: Int, z: Int): Chunk {
        ...
        val chunkBiomes = array2OfNulls<BiomeBase>(16, 16)
